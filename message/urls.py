...
from message.views import delete_message, update_message, get_all_messages_in_dialogue, get_last_messages_in_dialogue
...
urlpatterns = [
    ...
    path('messages/<int:user_id>/last', get_last_messages_in_dialogue, name="get_last_messages_in_dialogue")
]
